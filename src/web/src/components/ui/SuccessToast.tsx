...
export function SuccessToast({ message }: SuccessToastProps) {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[80] flex max-w-[calc(100vw-2.5rem)] items-center gap-3 rounded-xl border border-emerald-200/70 bg-white px-4 py-3 text-xs font-bold text-slate-700 shadow-[0_18px_45px_-18px_rgba(0,20,76,0.4)] animate-[success-toast-enter_260ms_cubic-bezier(0.22,1,0.36,1)]" role="status" aria-live="polite">
