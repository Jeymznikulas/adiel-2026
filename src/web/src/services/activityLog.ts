...
export type SystemLogAction = 'Created' | 'Updated' | 'Deleted' | 'Status changed' | 'Payment recorded' | 'Subtask added' | 'Subtask updated' | 'Subtask removed' | 'Added to Expenses' | 'Removed from Expenses'
