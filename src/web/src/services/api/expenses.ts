...
export const generateExpenseFromPurchaseOrder=(purchaseOrderId:string)=>apiRequest<Expense>('/purchase-orders/'+purchaseOrderId+'/expense',{method:'POST'})
