...
function VariantEditor({ variant, parentItemId, index, isProcessingPhoto, onUpdate, onPhotoChange, onRemove, showRemove = true }: { variant: ItemVariant; parentItemId?: string; index: number; isProcessingPhoto: boolean; onUpdate: (id: string, field: VariantEditableField, value: string) => void; onPhotoChange: (id: string, event: ChangeEvent<HTMLInputElement>) => void; onRemove: (id: string) => void; showRemove?: boolean }) {
