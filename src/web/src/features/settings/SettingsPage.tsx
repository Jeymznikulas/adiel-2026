...
type SettingsSection = 'company' | 'documents' | 'numbering' | 'payments' | 'options' | 'calendar'

function initialSection(): SettingsSection {
  const section = new URLSearchParams(window.location.search).get('section')
  return section === 'documents' || section === 'numbering' || section === 'payments' || section === 'options' || section === 'calendar' ? section : 'company'
}
...
export function SettingsPage() {
  ...
  return <div className="space-y-5 animate-[content-enter_320ms_cubic-bezier(0.22,1,0.36,1)]">
    ...
    <SummarySurface className="grid gap-5 xl:grid-cols-[1fr_auto] xl:items-center" aria-label="Settings summary">
      ...
      <nav className="grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-6" aria-label="Settings sections">
    ...
    </form> : activeSection === 'calendar' ? <GoogleCalendarSettings /> : <BusinessOptionsSettings initialTab={initialBusinessTab()} />}
