  ...
  return <div className="space-y-5 animate-[content-enter_320ms_cubic-bezier(0.22,1,0.36,1)]">
    ...
    <SummarySurface className="grid gap-5 xl:grid-cols-[1fr_auto] xl:items-center" aria-label="Settings summary">
      <div>
        ...
        <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500">Manage company details, document defaults, integrations, reusable options, and protected database backups.</p>
      </div>
      <nav className="grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-7" aria-label="Settings sections">
