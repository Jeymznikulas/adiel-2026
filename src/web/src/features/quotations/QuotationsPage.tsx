...
export function QuotationsPage({ currentUsername }: QuotationsPageProps) {
  ...
  if (routeQuotationId && !routeQuotation && !isFormOpen && isLoadingQuotations) return <section className="rounded-2xl border border-slate-200 bg-white"><RecordListSkeleton variant="cards" rows={3} /></section>
