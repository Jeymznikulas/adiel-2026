...
public interface ISettingsRepository
{
    ...
    Task<BusinessOption> CreateOptionAsync(string type, string name, CurrentUser actor, CancellationToken cancellationToken);
    Task<BusinessOption> RenameOptionAsync(Guid id, string name, long expectedVersion, CurrentUser actor, CancellationToken cancellationToken);
...
public sealed record BusinessOption(Guid Id, string Type, string Name, bool IsActive, int SortOrder, long UsageCount, DateTimeOffset UpdatedAt, long Version);
