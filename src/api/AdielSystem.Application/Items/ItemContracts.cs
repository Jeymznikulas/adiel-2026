...
public sealed record SaveItemVariantRequest(string Name, string Value, string? Photo, string? ProductCode, string? Barcode, string UnitOfMeasure, decimal UnitWeight, string Status, decimal RawCost, decimal SellingPrice, IReadOnlyList<SaveItemVariantSpecificationRequest> Specifications, long? Version = null);
...
public sealed record ItemVariantDto(Guid Id, string Name, string Value, string Photo, string ProductCode, string Barcode, string UnitOfMeasure, decimal UnitWeight, string Status, decimal RawCost, decimal SellingPrice, int SortOrder, IReadOnlyList<ItemVariantSpecificationDto> Specifications, DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt, long Version);
