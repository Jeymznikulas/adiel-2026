...
public sealed record SaveTaskRequest(string Title, string Description, string Priority, Guid? AssignedToId, string AssignedTo, DateOnly? DueDate, long? Version = null);
public sealed record CreateTaskRequest(string Title, string Description, string Status, string Priority, Guid? AssignedToId, string AssignedTo, DateOnly? DueDate);
...
public sealed record TaskDto(Guid Id, string Title, string Description, string Status, string Priority, Guid? AssignedToId, string AssignedTo, string AssignedBy, DateOnly? DueDate, DateTimeOffset? CompletedAt, DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt, DateTimeOffset? ArchivedAt, long Version, IReadOnlyList<SubtaskDto> Subtasks);
